...
export function LoginView({ onLogin, onSignUp }: LoginViewProps) {
  ...
  return (
    <div className="h-full overflow-y-auto bg-slate-50">
      {/* Hero Section */}
      <div className="bg-gradient-to-br from-[#0f1f3d] via-[#1e3a5f] to-[#0f172a] px-6 pt-12 pb-20">
        <div className="text-center">
          <div className="relative w-20 h-20 mx-auto mb-4 flex items-center justify-center">
            <div className="absolute top-0 left-0 w-6 h-6 border-t-2 border-l-2 border-emerald-400/40"></div>
            <div className="absolute top-0 right-0 w-6 h-6 border-t-2 border-r-2 border-emerald-400/40"></div>
            <div className="absolute bottom-0 left-0 w-6 h-6 border-b-2 border-l-2 border-emerald-400/40"></div>
            <div className="absolute bottom-0 right-0 w-6 h-6 border-b-2 border-r-2 border-emerald-400/40"></div>
          ...
          <h1 className="text-white text-3xl mb-1 font-[Magra] tracking-wide">LinkUp Athletics</h1>
          <p className="text-emerald-400 text-sm font-[Magra] uppercase tracking-widest">There Is No Offseason.</p>
        </div>
      </div>

      {/* Login Form — overlaps hero */}
      <div className="px-6 -mt-10">
        <div className="bg-white rounded-2xl shadow-2xl p-6 mb-4">
          <h2 className="text-slate-900 text-xl mb-5 text-center font-[Magra]">Welcome Back</h2>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border-2 border-slate-200 bg-white text-slate-900 placeholder-slate-400 focus:border-emerald-500 focus:outline-none transition-colors font-[Magra]"
              />
            </div>
            ...
            <button
              onClick={handleLogin}
              disabled={loading}
              className="w-full bg-gradient-to-br from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 disabled:opacity-60 text-white py-4 rounded-xl transition-all shadow-lg shadow-emerald-500/20 font-[Magra] flex items-center justify-center gap-2"
            >
            ...
            <div className="relative my-2">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-slate-400 font-[Magra]">OR</span>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full bg-white hover:bg-slate-50 disabled:opacity-60 text-slate-700 py-4 rounded-xl transition-all shadow-sm border-2 border-slate-200 hover:border-slate-300 active:scale-[0.98] font-[Magra] flex items-center justify-center gap-3"
            >
              {googleLoading ? (
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-5 mb-8">
          <p className="text-sm text-slate-500 text-center mb-3 font-[Magra]">New to LinkUp Athletics?</p>
          <button
            onClick={onSignUp}
            className="w-full bg-gradient-to-br from-[#1e3a5f] to-[#0f1f3d] hover:from-[#243f6b] hover:to-[#162440] text-white py-4 rounded-xl transition-all font-[Magra] tracking-wide"
          >
            Create Account
          </button>
        </div>
