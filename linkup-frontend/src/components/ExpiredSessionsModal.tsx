...
export function ExpiredSessionsModal({ onDismiss }: { onDismiss: () => void }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-[60] flex items-end sm:items-center justify-center p-0 sm:p-4 pb-[72px] sm:pb-4">
      <div className="bg-white rounded-t-3xl sm:rounded-2xl w-full sm:max-w-md max-h-[75vh] flex flex-col">
        {/* Header */}
