 ...
 * The package ships only with a Cocoapods setup; this script creates the
 * Package.swift and SPM source directory that Capacitor 8 expects.
 *
...
// Create SPM source directory
fs.mkdirSync(spmSrcDir, { recursive: true });

// Copy Swift + ObjC source files
...
// Write Package.swift (overwrite if already there to keep it current)
